/* mediators_sim.c generated by valac 0.16.0, the Vala compiler
...
static gboolean samsung_sim_get_information_real_run_co (SamsungSimGetInformationRunData* _data_) {
	...
	_data_->_tmp23_ = _data_->_tmp22_;
	_data_->_tmp24_ = g_strdup ("phonebooks");
	_data_->_tmp25_ = _variant_new2 ("");
	g_hash_table_insert (_data_->_tmp23_, _data_->_tmp24_, _data_->_tmp25_);
	_data_->_tmp26_ = fso_gsm_sim_get_information_get_info ((FsoGsmSimGetInformation*) _data_->self);
	_data_->_tmp27_ = _data_->_tmp26_;
	_data_->_tmp28_ = g_strdup ("slots");
	_data_->_tmp29_ = _variant_new3 ("0");
	g_hash_table_insert (_data_->_tmp27_, _data_->_tmp28_, _data_->_tmp29_);
	_data_->_tmp30_ = fso_gsm_sim_get_information_get_info ((FsoGsmSimGetInformation*) _data_->self);
	_data_->_tmp31_ = _data_->_tmp30_;
	_data_->_tmp32_ = g_strdup ("used");
	_data_->_tmp33_ = _variant_new4 ("0");
