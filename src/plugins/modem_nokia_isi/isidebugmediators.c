/* isidebugmediators.c generated by valac 0.16.1, the Vala compiler
...
static void __lambda26_ (Block5Data* _data5_, GIsiCommErrorCode _error_, guint8* answer, int answer_length1);
static void ___lambda26__gisi_comm_byte_array_result_func (GIsiCommErrorCode code, guint8* array, int array_length1, gpointer self);
...
static void ___lambda26__gisi_comm_byte_array_result_func (GIsiCommErrorCode code, guint8* array, int array_length1, gpointer self) {
	__lambda26_ (self, code, array, array_length1);
}
...
static gboolean nokia_isi_isi_debug_command_real_run_co (NokiaIsiIsiDebugCommandRunData* _data_) {
	...
	gisi_comm_abstract_base_client_sendGenericRequest (_data_->_tmp55_, _data_->_tmp56_, _data_->_tmp56__length1, ___lambda26__gisi_comm_byte_array_result_func, _data_->_data5_);
	_data_->_state_ = 1;
	return FALSE;
	_state_1:
	;
