/* watchdog.c generated by valac 0.16.1, the Vala compiler
 * generated from watchdog.vala, do not modify */
...
typedef struct _fso_gsm_generic_watch_dog_unlockModemData fso_gsm_generic_watch_dog_unlockModemData;
...
typedef struct _fso_gsm_generic_watch_dog_campNetworkData fso_gsm_generic_watch_dog_campNetworkData;
...
struct _FsoGsmGenericWatchDogPrivate {
	gboolean unlockFailed;
	FsoGsmModemStatus lastStatus;
	gboolean inCampNetwork;
	FsoGsmModem* modem;
};
...
struct _fso_gsm_generic_watch_dog_unlockModemData {
	int _state_;
	GObject* _source_object_;
	GAsyncResult* _res_;
	GSimpleAsyncResult* _async_result;
	FsoGsmGenericWatchDog* self;
	FsoGsmModem* _tmp0_;
	gpointer _tmp1_;
...
struct _fso_gsm_generic_watch_dog_campNetworkData {
	int _state_;
	GObject* _source_object_;
	GAsyncResult* _res_;
	GSimpleAsyncResult* _async_result;
...
static gpointer fso_gsm_null_watch_dog_parent_class = NULL;
static FsoGsmWatchDogIface* fso_gsm_null_watch_dog_fso_gsm_watch_dog_parent_iface = NULL;
static gpointer fso_gsm_generic_watch_dog_parent_class = NULL;
static FsoGsmWatchDogIface* fso_gsm_generic_watch_dog_fso_gsm_watch_dog_parent_iface = NULL;
...
enum  {
	FSO_GSM_NULL_WATCH_DOG_DUMMY_PROPERTY
};
static void fso_gsm_null_watch_dog_real_check (FsoGsmWatchDog* base);
static void fso_gsm_null_watch_dog_real_resetUnlockMarker (FsoGsmWatchDog* base);
...
#define FSO_GSM_GENERIC_WATCH_DOG_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), FSO_GSM_TYPE_GENERIC_WATCH_DOG, FsoGsmGenericWatchDogPrivate))
enum  {
	FSO_GSM_GENERIC_WATCH_DOG_DUMMY_PROPERTY
};
static gchar* fso_gsm_generic_watch_dog_real_repr (FsoFrameworkAbstractObject* base);
static void fso_gsm_generic_watch_dog_onModemStatusChange (FsoGsmGenericWatchDog* self, FsoGsmModemStatus status);
...
static void fso_gsm_generic_watch_dog_unlockModem (FsoGsmGenericWatchDog* self, GAsyncReadyCallback _callback_, gpointer _user_data_);
static void fso_gsm_generic_watch_dog_unlockModem_finish (FsoGsmGenericWatchDog* self, GAsyncResult* _res_);
static void fso_gsm_generic_watch_dog_campNetwork (FsoGsmGenericWatchDog* self, GAsyncReadyCallback _callback_, gpointer _user_data_);
static void fso_gsm_generic_watch_dog_campNetwork_finish (FsoGsmGenericWatchDog* self, GAsyncResult* _res_);
...
static void fso_gsm_generic_watch_dog_unlockModem_data_free (gpointer _data);
static gboolean fso_gsm_generic_watch_dog_unlockModem_co (fso_gsm_generic_watch_dog_unlockModemData* _data_);
...
static void fso_gsm_generic_watch_dog_unlockModem_ready (GObject* source_object, GAsyncResult* _res_, gpointer _user_data_);
...
static void fso_gsm_generic_watch_dog_campNetwork_data_free (gpointer _data);
static gboolean fso_gsm_generic_watch_dog_campNetwork_co (fso_gsm_generic_watch_dog_campNetworkData* _data_);
...
static void fso_gsm_generic_watch_dog_campNetwork_ready (GObject* source_object, GAsyncResult* _res_, gpointer _user_data_);
...
static void _fso_gsm_generic_watch_dog_onModemStatusChange_fso_gsm_modem_signal_status_changed (FsoGsmModem* _sender, FsoGsmModemStatus status, gpointer self);
static void fso_gsm_generic_watch_dog_real_check (FsoGsmWatchDog* base);
static void fso_gsm_generic_watch_dog_real_resetUnlockMarker (FsoGsmWatchDog* base);
static void fso_gsm_generic_watch_dog_finalize (GObject* obj);


void fso_gsm_watch_dog_check (FsoGsmWatchDog* self) {
	g_return_if_fail (self != NULL);
	FSO_GSM_WATCH_DOG_GET_INTERFACE (self)->check (self);
}


void fso_gsm_watch_dog_resetUnlockMarker (FsoGsmWatchDog* self) {
	g_return_if_fail (self != NULL);
	FSO_GSM_WATCH_DOG_GET_INTERFACE (self)->resetUnlockMarker (self);
}


static void fso_gsm_watch_dog_base_init (FsoGsmWatchDogIface * iface) {
 ...
 * @interface WatchDog
 **/
GType fso_gsm_watch_dog_get_type (void) {
	static volatile gsize fso_gsm_watch_dog_type_id__volatile = 0;
	if (g_once_init_enter (&fso_gsm_watch_dog_type_id__volatile)) {
		static const GTypeInfo g_define_type_info = { sizeof (FsoGsmWatchDogIface), (GBaseInitFunc) fso_gsm_watch_dog_base_init, (GBaseFinalizeFunc) NULL, (GClassInitFunc) NULL, (GClassFinalizeFunc) NULL, NULL, 0, 0, (GInstanceInitFunc) NULL, NULL };
		GType fso_gsm_watch_dog_type_id;
		fso_gsm_watch_dog_type_id = g_type_register_static (G_TYPE_INTERFACE, "FsoGsmWatchDog", &g_define_type_info, 0);
		g_type_interface_add_prerequisite (fso_gsm_watch_dog_type_id, G_TYPE_OBJECT);
		g_once_init_leave (&fso_gsm_watch_dog_type_id__volatile, fso_gsm_watch_dog_type_id);
	}
	return fso_gsm_watch_dog_type_id__volatile;
}


static void fso_gsm_null_watch_dog_real_check (FsoGsmWatchDog* base) {
	FsoGsmNullWatchDog * self;
	self = (FsoGsmNullWatchDog*) base;
}
...
FsoGsmNullWatchDog* fso_gsm_null_watch_dog_construct (GType object_type) {
	FsoGsmNullWatchDog * self = NULL;
	self = (FsoGsmNullWatchDog*) g_object_new (object_type, NULL);
	return self;
}


FsoGsmNullWatchDog* fso_gsm_null_watch_dog_new (void) {
	return fso_gsm_null_watch_dog_construct (FSO_GSM_TYPE_NULL_WATCH_DOG);
}


static void fso_gsm_null_watch_dog_class_init (FsoGsmNullWatchDogClass * klass) {
	fso_gsm_null_watch_dog_parent_class = g_type_class_peek_parent (klass);
}


static void fso_gsm_null_watch_dog_fso_gsm_watch_dog_interface_init (FsoGsmWatchDogIface * iface) {
	fso_gsm_null_watch_dog_fso_gsm_watch_dog_parent_iface = g_type_interface_peek_parent (iface);
	iface->check = (void (*)(FsoGsmWatchDog*)) fso_gsm_null_watch_dog_real_check;
	iface->resetUnlockMarker = (void (*)(FsoGsmWatchDog*)) fso_gsm_null_watch_dog_real_resetUnlockMarker;
}


static void fso_gsm_null_watch_dog_instance_init (FsoGsmNullWatchDog * self) {
}
 ...
 * @class NullWatchDog
 **/
GType fso_gsm_null_watch_dog_get_type (void) {
	static volatile gsize fso_gsm_null_watch_dog_type_id__volatile = 0;
	if (g_once_init_enter (&fso_gsm_null_watch_dog_type_id__volatile)) {
		static const GTypeInfo g_define_type_info = { sizeof (FsoGsmNullWatchDogClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) fso_gsm_null_watch_dog_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (FsoGsmNullWatchDog), 0, (GInstanceInitFunc) fso_gsm_null_watch_dog_instance_init, NULL };
		static const GInterfaceInfo fso_gsm_watch_dog_info = { (GInterfaceInitFunc) fso_gsm_null_watch_dog_fso_gsm_watch_dog_interface_init, (GInterfaceFinalizeFunc) NULL, NULL};
		GType fso_gsm_null_watch_dog_type_id;
		fso_gsm_null_watch_dog_type_id = g_type_register_static (G_TYPE_OBJECT, "FsoGsmNullWatchDog", &g_define_type_info, 0);
		g_type_add_interface_static (fso_gsm_null_watch_dog_type_id, FSO_GSM_TYPE_WATCH_DOG, &fso_gsm_watch_dog_info);
		g_once_init_leave (&fso_gsm_null_watch_dog_type_id__volatile, fso_gsm_null_watch_dog_type_id);
	}
	return fso_gsm_null_watch_dog_type_id__volatile;
}
...
static gchar* fso_gsm_generic_watch_dog_real_repr (FsoFrameworkAbstractObject* base) {
	...
	gchar* result = NULL;
	gchar* _tmp0_;
	self = (FsoGsmGenericWatchDog*) base;
	_tmp0_ = g_strdup ("<>");
	result = _tmp0_;
	return result;
}
...
static void fso_gsm_generic_watch_dog_onModemStatusChange (FsoGsmGenericWatchDog* self, FsoGsmModemStatus status) {
	...
	FsoGsmModem* _tmp8_;
	FsoGsmModemData* _tmp9_ = NULL;
	FsoGsmModemData* data;
	FsoGsmModemStatus _tmp10_;
	FsoGsmModemStatus _tmp27_;
	g_return_if_fail (self != NULL);
	_tmp0_ = ((FsoFrameworkAbstractObject*) self)->logger;
	_tmp1_ = self->priv->lastStatus;
	_tmp2_ = g_enum_get_value (g_type_class_ref (FSO_GSM_MODEM_TYPE_STATUS), _tmp1_);
	_tmp3_ = status;
	_tmp4_ = g_enum_get_value (g_type_class_ref (FSO_GSM_MODEM_TYPE_STATUS), _tmp3_);
	_tmp5_ = g_strconcat ("onModemStatusChange ", (_tmp2_ != NULL) ? _tmp2_->value_name : NULL, " -> ", (_tmp4_ != NULL) ? _tmp4_->value_name : NULL, NULL);
	_tmp6_ = _tmp5_;
	_tmp7_ = fso_framework_logger_debug (_tmp0_, _tmp6_);
	g_assert (_tmp7_);
	_g_free0 (_tmp6_);
	_tmp8_ = self->priv->modem;
	_tmp9_ = fso_gsm_modem_data (_tmp8_);
	data = _tmp9_;
	_tmp10_ = status;
	switch (_tmp10_) {
		case FSO_GSM_MODEM_STATUS_ALIVE_SIM_LOCKED:
		{
			...
			if (_tmp14_ == FREE_SMARTPHONE_GSM_SIM_AUTH_STATUS_PIN_REQUIRED) {
				FsoGsmModemData* _tmp15_;
				const gchar* _tmp16_;
				_tmp15_ = data;
				_tmp16_ = _tmp15_->simPin;
			...
			if (_tmp17_) {
				gboolean _tmp18_;
				_tmp18_ = self->priv->unlockFailed;
				_tmp11_ = !_tmp18_;
			} else {
				_tmp11_ = FALSE;
			}
			_tmp19_ = _tmp11_;
			if (_tmp19_) {
				fso_gsm_generic_watch_dog_unlockModem (self, NULL, NULL);
			}
			break;
		}
		...
		{
			FsoGsmModem* _tmp20_;
			FsoGsmModemData* _tmp21_ = NULL;
			FsoGsmModemData* _tmp22_;
			gboolean _tmp23_;
			gboolean _tmp24_;
			_tmp20_ = self->priv->modem;
			_tmp21_ = fso_gsm_modem_data (_tmp20_);
			_tmp22_ = _tmp21_;
			_tmp23_ = _tmp22_->keepRegistration;
			_tmp24_ = _tmp23_;
			_g_object_unref0 (_tmp22_);
			if (_tmp24_) {
				fso_gsm_generic_watch_dog_campNetwork (self, NULL, NULL);
			}
			break;
		}
		case FSO_GSM_MODEM_STATUS_ALIVE_REGISTERED:
		{
			...
			_tmp25_ = self->priv->lastStatus;
			if (_tmp25_ == FSO_GSM_MODEM_STATUS_RESUMING) {
				FsoGsmModem* _tmp26_;
				_tmp26_ = self->priv->modem;
				fso_gsm_triggerUpdateNetworkStatus (_tmp26_, NULL, NULL);
			}
			break;
		}
		default:
	...
	_tmp27_ = status;
	self->priv->lastStatus = _tmp27_;
	_g_object_unref0 (data);
}


static void fso_gsm_generic_watch_dog_unlockModem_data_free (gpointer _data) {
	fso_gsm_generic_watch_dog_unlockModemData* _data_;
	_data_ = _data;
	_g_object_unref0 (_data_->self);
	g_slice_free (fso_gsm_generic_watch_dog_unlockModemData, _data_);
}
...
static void fso_gsm_generic_watch_dog_unlockModem (FsoGsmGenericWatchDog* self, GAsyncReadyCallback _callback_, gpointer _user_data_) {
	...
	_data_ = g_slice_new0 (fso_gsm_generic_watch_dog_unlockModemData);
	_data_->_async_result = g_simple_async_result_new (G_OBJECT (self), _callback_, _user_data_, fso_gsm_generic_watch_dog_unlockModem);
	g_simple_async_result_set_op_res_gpointer (_data_->_async_result, _data_, fso_gsm_generic_watch_dog_unlockModem_data_free);
	_tmp0_ = _g_object_ref0 (self);
	_data_->self = _tmp0_;
	fso_gsm_generic_watch_dog_unlockModem_co (_data_);
}
...
static gboolean fso_gsm_generic_watch_dog_unlockModem_co (fso_gsm_generic_watch_dog_unlockModemData* _data_) {
	...
	_state_0:
	{
		...
		_data_->_tmp3_ = _data_->self->priv->modem;
		_data_->_tmp4_ = NULL;
		_data_->_tmp4_ = fso_gsm_modem_data (_data_->_tmp3_);
		_data_->_tmp5_ = _data_->_tmp4_;
		_data_->_tmp6_ = _data_->_tmp5_->simPin;
		_data_->_state_ = 1;
		fso_gsm_sim_send_auth_code_run (_data_->_tmp2_, _data_->_tmp6_, fso_gsm_generic_watch_dog_unlockModem_ready, _data_);
		return FALSE;
		_state_1:
	...
	__catch63_g_error:
	{
		...
		_data_->_tmp11_ = NULL;
		_data_->_tmp11_ = g_strconcat ("Could not unlock SIM PIN: ", _data_->_tmp10_, NULL);
		_data_->_tmp12_ = _data_->_tmp11_;
		fso_framework_logger_error (_data_->_tmp7_, _data_->_tmp12_);
		_g_free0 (_data_->_tmp12_);
		_data_->self->priv->unlockFailed = TRUE;
		{
			_data_->_tmp13_ = _data_->self->priv->modem;
			_data_->_state_ = 2;
			fso_gsm_gatherSimStatusAndUpdate (_data_->_tmp13_, fso_gsm_generic_watch_dog_unlockModem_ready, _data_);
			return FALSE;
			_state_2:
		...
		__catch64_g_error:
		{
			...
			_data_->_tmp18_ = NULL;
			_data_->_tmp18_ = g_strconcat ("Can't gather SIM status: ", _data_->_tmp17_, NULL);
...
static void fso_gsm_generic_watch_dog_campNetwork_data_free (gpointer _data) {
	fso_gsm_generic_watch_dog_campNetworkData* _data_;
	_data_ = _data;
	_g_object_unref0 (_data_->self);
	g_slice_free (fso_gsm_generic_watch_dog_campNetworkData, _data_);
}
...
static void fso_gsm_generic_watch_dog_campNetwork (FsoGsmGenericWatchDog* self, GAsyncReadyCallback _callback_, gpointer _user_data_) {
	fso_gsm_generic_watch_dog_campNetworkData* _data_;
	FsoGsmGenericWatchDog* _tmp0_;
	_data_ = g_slice_new0 (fso_gsm_generic_watch_dog_campNetworkData);
	_data_->_async_result = g_simple_async_result_new (G_OBJECT (self), _callback_, _user_data_, fso_gsm_generic_watch_dog_campNetwork);
	g_simple_async_result_set_op_res_gpointer (_data_->_async_result, _data_, fso_gsm_generic_watch_dog_campNetwork_data_free);
	_tmp0_ = _g_object_ref0 (self);
	_data_->self = _tmp0_;
	fso_gsm_generic_watch_dog_campNetwork_co (_data_);
}
...
static gboolean fso_gsm_generic_watch_dog_campNetwork_co (fso_gsm_generic_watch_dog_campNetworkData* _data_) {
	...
	_state_0:
	_data_->_tmp0_ = _data_->self->priv->inCampNetwork;
	if (_data_->_tmp0_) {
		if (_data_->_state_ == 0) {
			g_simple_async_result_complete_in_idle (_data_->_async_result);
		} else {
	...
	_data_->self->priv->inCampNetwork = TRUE;
	{
		_data_->_tmp1_ = _data_->self->priv->modem;
		_data_->_tmp2_ = NULL;
		_data_->_tmp2_ = fso_gsm_modem_createMediator (_data_->_tmp1_, FSO_GSM_TYPE_NETWORK_REGISTER, (GBoxedCopyFunc) g_object_ref, g_object_unref, &_data_->_inner_error_);
		_data_->m = (FsoGsmNetworkRegister*) _data_->_tmp2_;
		if (_data_->_inner_error_ != NULL) {
			goto __catch65_g_error;
		}
		_data_->_tmp3_ = _data_->m;
		_data_->_state_ = 1;
		fso_gsm_network_register_run (_data_->_tmp3_, fso_gsm_generic_watch_dog_campNetwork_ready, _data_);
		return FALSE;
		_state_1:
		fso_gsm_network_register_run_finish (_data_->_tmp3_, _data_->_res_, &_data_->_inner_error_);
		if (_data_->_inner_error_ != NULL) {
			_g_object_unref0 (_data_->m);
			goto __catch65_g_error;
		}
	...
	__catch65_g_error:
	{
		...
		_data_->_tmp8_ = NULL;
		_data_->_tmp8_ = g_strconcat ("Could not register: ", _data_->_tmp7_, NULL);
	...
	_data_->_tmp10_ = _data_->self->priv->modem;
	fso_gsm_triggerUpdateNetworkStatus (_data_->_tmp10_, NULL, NULL);
	_data_->self->priv->inCampNetwork = FALSE;
	if (_data_->_state_ == 0) {
		g_simple_async_result_complete_in_idle (_data_->_async_result);
	} else {
		g_simple_async_result_complete (_data_->_async_result);
...
static void _fso_gsm_generic_watch_dog_onModemStatusChange_fso_gsm_modem_signal_status_changed (FsoGsmModem* _sender, FsoGsmModemStatus status, gpointer self) {
	fso_gsm_generic_watch_dog_onModemStatusChange (self, status);
}


FsoGsmGenericWatchDog* fso_gsm_generic_watch_dog_construct (GType object_type, FsoGsmModem* modem) {
	FsoGsmGenericWatchDog * self = NULL;
	FsoGsmModem* _tmp0_;
	FsoGsmModem* _tmp1_;
	FsoGsmModem* _tmp2_;
	...
	self = (FsoGsmGenericWatchDog*) fso_framework_abstract_object_construct (object_type);
	_tmp0_ = modem;
	...
	self->priv->lastStatus = _tmp3_;
	_tmp4_ = modem;
	g_signal_connect_object (_tmp4_, "signal-status-changed", (GCallback) _fso_gsm_generic_watch_dog_onModemStatusChange_fso_gsm_modem_signal_status_changed, self, 0);
	return self;
}


FsoGsmGenericWatchDog* fso_gsm_generic_watch_dog_new (FsoGsmModem* modem) {
	return fso_gsm_generic_watch_dog_construct (FSO_GSM_TYPE_GENERIC_WATCH_DOG, modem);
}
...
static void fso_gsm_generic_watch_dog_real_check (FsoGsmWatchDog* base) {
	FsoGsmGenericWatchDog * self;
	FsoGsmModem* _tmp0_;
	FsoGsmModemStatus _tmp1_ = 0;
	self = (FsoGsmGenericWatchDog*) base;
	_tmp0_ = self->priv->modem;
	_tmp1_ = fso_gsm_modem_status (_tmp0_);
	fso_gsm_generic_watch_dog_onModemStatusChange (self, _tmp1_);
}
...
static void fso_gsm_generic_watch_dog_real_resetUnlockMarker (FsoGsmWatchDog* base) {
	FsoGsmGenericWatchDog * self;
	self = (FsoGsmGenericWatchDog*) base;
	self->priv->unlockFailed = FALSE;
}


static void fso_gsm_generic_watch_dog_class_init (FsoGsmGenericWatchDogClass * klass) {
	fso_gsm_generic_watch_dog_parent_class = g_type_class_peek_parent (klass);
	g_type_class_add_private (klass, sizeof (FsoGsmGenericWatchDogPrivate));
	FSO_FRAMEWORK_ABSTRACT_OBJECT_CLASS (klass)->repr = fso_gsm_generic_watch_dog_real_repr;
	G_OBJECT_CLASS (klass)->finalize = fso_gsm_generic_watch_dog_finalize;
}


static void fso_gsm_generic_watch_dog_fso_gsm_watch_dog_interface_init (FsoGsmWatchDogIface * iface) {
	fso_gsm_generic_watch_dog_fso_gsm_watch_dog_parent_iface = g_type_interface_peek_parent (iface);
	iface->check = (void (*)(FsoGsmWatchDog*)) fso_gsm_generic_watch_dog_real_check;
	iface->resetUnlockMarker = (void (*)(FsoGsmWatchDog*)) fso_gsm_generic_watch_dog_real_resetUnlockMarker;
}


static void fso_gsm_generic_watch_dog_instance_init (FsoGsmGenericWatchDog * self) {
	self->priv = FSO_GSM_GENERIC_WATCH_DOG_GET_PRIVATE (self);
	self->priv->inCampNetwork = FALSE;
}


static void fso_gsm_generic_watch_dog_finalize (GObject* obj) {
	FsoGsmGenericWatchDog * self;
	self = FSO_GSM_GENERIC_WATCH_DOG (obj);
	_g_object_unref0 (self->priv->modem);
	G_OBJECT_CLASS (fso_gsm_generic_watch_dog_parent_class)->finalize (obj);
}
 ...
 *
 **/
GType fso_gsm_generic_watch_dog_get_type (void) {
	static volatile gsize fso_gsm_generic_watch_dog_type_id__volatile = 0;
	if (g_once_init_enter (&fso_gsm_generic_watch_dog_type_id__volatile)) {
		static const GTypeInfo g_define_type_info = { sizeof (FsoGsmGenericWatchDogClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) fso_gsm_generic_watch_dog_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (FsoGsmGenericWatchDog), 0, (GInstanceInitFunc) fso_gsm_generic_watch_dog_instance_init, NULL };
		static const GInterfaceInfo fso_gsm_watch_dog_info = { (GInterfaceInitFunc) fso_gsm_generic_watch_dog_fso_gsm_watch_dog_interface_init, (GInterfaceFinalizeFunc) NULL, NULL};
		GType fso_gsm_generic_watch_dog_type_id;
		fso_gsm_generic_watch_dog_type_id = g_type_register_static (FSO_FRAMEWORK_TYPE_ABSTRACT_OBJECT, "FsoGsmGenericWatchDog", &g_define_type_info, 0);
		g_type_add_interface_static (fso_gsm_generic_watch_dog_type_id, FSO_GSM_TYPE_WATCH_DOG, &fso_gsm_watch_dog_info);
		g_once_init_leave (&fso_gsm_generic_watch_dog_type_id__volatile, fso_gsm_generic_watch_dog_type_id);
	}
	return fso_gsm_generic_watch_dog_type_id__volatile;
}
