/* pdp.c generated by valac 0.16.0, the Vala compiler
...
static const gchar* _variant_get70 (GVariant* value);
static const gchar* _variant_get71 (GVariant* value);
...
static gboolean fso_gsm_pdp_handler_real_syncStatus_co (fso_gsm_pdp_handler_syncStatusData* _data_) {
	...
	}
	{
		...
		if (_data_->_tmp25_ == NULL) {
			...
			_data_->_tmp28_ = _variant_get71 ((GVariant*) _data_->_tmp27_);
