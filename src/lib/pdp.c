/* pdp.c generated by valac 0.14.2, the Vala compiler
...
static void ___lambda1__free_smartphone_gsm_network_status (FreeSmartphoneGSMNetwork* _sender, GHashTable* status, gpointer self);
static void __lambda2_ (FsoGsmPdpHandler* self, FreeSmartphoneGSMDeviceStatus status);
static void ___lambda2__free_smartphone_gsm_device_device_status (FreeSmartphoneGSMDevice* _sender, FreeSmartphoneGSMDeviceStatus status, gpointer self);
static gboolean __fso_gsm_pdp_handler___lambda0__gsource_func (gpointer self);
...
static gboolean _fso_gsm_pdp_handler___lambda0_ (FsoGsmPdpHandler* self) {
	...
	_tmp2_ = network;
	g_signal_connect_object (_tmp2_, "status", (GCallback) ___lambda1__free_smartphone_gsm_network_status, self, 0);
	...
	_tmp5_ = device;
	g_signal_connect_object (_tmp5_, "device-status", (GCallback) ___lambda2__free_smartphone_gsm_device_device_status, self, 0);
	result = FALSE;
...
static gboolean __fso_gsm_pdp_handler___lambda0__gsource_func (gpointer self) {
	gboolean result;
	result = _fso_gsm_pdp_handler___lambda0_ (self);
	return result;
}
