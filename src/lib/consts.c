/* consts.c generated by valac 0.14.2, the Vala compiler
...
typedef struct _FsoGsmParamSpecConstants FsoGsmParamSpecConstants;
...
struct _FsoGsmParamSpecConstants {
	GParamSpec parent_instance;
};


static gpointer fso_gsm_constants_parent_class = NULL;
extern FsoGsmConstants* fso_gsm_constants__instance;
FsoGsmConstants* fso_gsm_constants__instance = NULL;
...
enum  {
	FSO_GSM_CONSTANTS_DUMMY_PROPERTY
};
...
static void fso_gsm_constants_finalize (FsoGsmConstants* obj);
...
static gpointer _fso_gsm_constants_ref0 (gpointer self) {
	return self ? fso_gsm_constants_ref (self) : NULL;
}


FsoGsmConstants* fso_gsm_constants_instance (void) {
	FsoGsmConstants* result = NULL;
	FsoGsmConstants* _tmp0_;
	FsoGsmConstants* _tmp2_;
	FsoGsmConstants* _tmp3_;
	_tmp0_ = fso_gsm_constants__instance;
	if (_tmp0_ == NULL) {
		FsoGsmConstants* _tmp1_;
		_tmp1_ = fso_gsm_constants_new ();
		_fso_gsm_constants_unref0 (fso_gsm_constants__instance);
		fso_gsm_constants__instance = _tmp1_;
	}
	_tmp2_ = fso_gsm_constants__instance;
	_tmp3_ = _fso_gsm_constants_ref0 (_tmp2_);
	result = _tmp3_;
	return result;
}
...
GError* fso_gsm_constants_atResponseCodeToError (FsoGsmConstants* self, FsoGsmConstantsAtResponse code, const gchar* detail) {
	...
	switch (_tmp0_) {
		...
		default:
		{
			...
			GError* _tmp6_;
			_tmp5_ = detail;
			_tmp6_ = g_error_new_literal (FREE_SMARTPHONE_GSM_ERROR, FREE_SMARTPHONE_GSM_ERROR_DEVICE_FAILED, _tmp5_);
			result = _tmp6_;
			return result;
		}
	}
...
gint fso_gsm_constants_simFilesystemEntryNameToCode (FsoGsmConstants* self, const gchar* name) {
	...
	_tmp5_ = name;
	g_warning ("consts.vala:464: simFilesystemEntryNameToCode: '%s' not found", _tmp5_);
	result = -1;
	return result;
}
	...
	if (_tmp3_ == ((0 != _tmp2_label0) ? _tmp2_label0 : (_tmp2_label0 = g_quark_from_static_string ("unread")))) {
		...
		switch (0) {
			default:
			{
				...
				_tmp7_ = _tmp6_;
				g_warning ("consts.vala:483: %s", _tmp7_);
				_g_free0 (_tmp7_);
...
gchar* fso_gsm_constants_simMessagebookStatusToString (FsoGsmConstants* self, gint code) {
	...
	switch (_tmp0_) {
		...
		default:
		{
			...
			_tmp9_ = _tmp8_;
			g_warning ("consts.vala:501: %s", _tmp9_);
			_g_free0 (_tmp9_);
			_g_free0 (_tmp7_);
	...
	if (_tmp3_ == ((0 != _tmp2_label0) ? _tmp2_label0 : (_tmp2_label0 = g_quark_from_static_string ("READY")))) {
		...
		switch (0) {
			default:
			{
				const gchar* _tmp4_;
				_tmp4_ = status;
				g_warning ("consts.vala:717: unknown SIM PIN status %s!!!", _tmp4_);
...
FreeSmartphoneGSMCallStatus fso_gsm_constants_callStatusToEnum (FsoGsmConstants* self, gint code) {
	...
	switch (_tmp0_) {
		...
		default:
		{
			g_warning ("consts.vala:756: invalid call status!!! setting to RELEASE");
...
FsoGsmConstants* fso_gsm_constants_construct (GType object_type) {
	FsoGsmConstants* self = NULL;
	self = (FsoGsmConstants*) g_type_create_instance (object_type);
	return self;
}


FsoGsmConstants* fso_gsm_constants_new (void) {
	return fso_gsm_constants_construct (FSO_GSM_TYPE_CONSTANTS);
}
...
static void fso_gsm_value_constants_init (GValue* value) {
	value->data[0].v_pointer = NULL;
}


static void fso_gsm_value_constants_free_value (GValue* value) {
	if (value->data[0].v_pointer) {
		fso_gsm_constants_unref (value->data[0].v_pointer);
	}
}


static void fso_gsm_value_constants_copy_value (const GValue* src_value, GValue* dest_value) {
	if (src_value->data[0].v_pointer) {
		dest_value->data[0].v_pointer = fso_gsm_constants_ref (src_value->data[0].v_pointer);
	} else {
...
static gpointer fso_gsm_value_constants_peek_pointer (const GValue* value) {
	return value->data[0].v_pointer;
}


static gchar* fso_gsm_value_constants_collect_value (GValue* value, guint n_collect_values, GTypeCValue* collect_values, guint collect_flags) {
	if (collect_values[0].v_pointer) {
		FsoGsmConstants* object;
		...
		value->data[0].v_pointer = fso_gsm_constants_ref (object);
	} else {
		value->data[0].v_pointer = NULL;
	}
	return NULL;
...
static gchar* fso_gsm_value_constants_lcopy_value (const GValue* value, guint n_collect_values, GTypeCValue* collect_values, guint collect_flags) {
	FsoGsmConstants** object_p;
	...
	if (!value->data[0].v_pointer) {
		...
		*object_p = fso_gsm_constants_ref (value->data[0].v_pointer);
	}
	return NULL;
}
...
GParamSpec* fso_gsm_param_spec_constants (const gchar* name, const gchar* nick, const gchar* blurb, GType object_type, GParamFlags flags) {
	FsoGsmParamSpecConstants* spec;
	g_return_val_if_fail (g_type_is_a (object_type, FSO_GSM_TYPE_CONSTANTS), NULL);
...
gpointer fso_gsm_value_get_constants (const GValue* value) {
	g_return_val_if_fail (G_TYPE_CHECK_VALUE_TYPE (value, FSO_GSM_TYPE_CONSTANTS), NULL);
	return value->data[0].v_pointer;
}
...
void fso_gsm_value_set_constants (GValue* value, gpointer v_object) {
	FsoGsmConstants* old;
	g_return_if_fail (G_TYPE_CHECK_VALUE_TYPE (value, FSO_GSM_TYPE_CONSTANTS));
	old = value->data[0].v_pointer;
	if (v_object) {
		g_return_if_fail (G_TYPE_CHECK_INSTANCE_TYPE (v_object, FSO_GSM_TYPE_CONSTANTS));
		g_return_if_fail (g_value_type_compatible (G_TYPE_FROM_INSTANCE (v_object), G_VALUE_TYPE (value)));
		value->data[0].v_pointer = v_object;
		fso_gsm_constants_ref (value->data[0].v_pointer);
	} else {
		value->data[0].v_pointer = NULL;
	}
	if (old) {
		fso_gsm_constants_unref (old);
	}
}
...
static void fso_gsm_constants_class_init (FsoGsmConstantsClass * klass) {
	fso_gsm_constants_parent_class = g_type_class_peek_parent (klass);
	FSO_GSM_CONSTANTS_CLASS (klass)->finalize = fso_gsm_constants_finalize;
}


static void fso_gsm_constants_instance_init (FsoGsmConstants * self) {
	self->ref_count = 1;
}


static void fso_gsm_constants_finalize (FsoGsmConstants* obj) {
	FsoGsmConstants * self;
	self = FSO_GSM_CONSTANTS (obj);
}
 ...
 **/
GType fso_gsm_constants_get_type (void) {
	static volatile gsize fso_gsm_constants_type_id__volatile = 0;
	if (g_once_init_enter (&fso_gsm_constants_type_id__volatile)) {
		static const GTypeValueTable g_define_type_value_table = { fso_gsm_value_constants_init, fso_gsm_value_constants_free_value, fso_gsm_value_constants_copy_value, fso_gsm_value_constants_peek_pointer, "p", fso_gsm_value_constants_collect_value, "p", fso_gsm_value_constants_lcopy_value };
		static const GTypeInfo g_define_type_info = { sizeof (FsoGsmConstantsClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) fso_gsm_constants_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (FsoGsmConstants), 0, (GInstanceInitFunc) fso_gsm_constants_instance_init, &g_define_type_value_table };
		static const GTypeFundamentalInfo g_define_type_fundamental_info = { (G_TYPE_FLAG_CLASSED | G_TYPE_FLAG_INSTANTIATABLE | G_TYPE_FLAG_DERIVABLE | G_TYPE_FLAG_DEEP_DERIVABLE) };
		GType fso_gsm_constants_type_id;
		fso_gsm_constants_type_id = g_type_register_fundamental (g_type_fundamental_next (), "FsoGsmConstants", &g_define_type_info, &g_define_type_fundamental_info, 0);
		g_once_init_leave (&fso_gsm_constants_type_id__volatile, fso_gsm_constants_type_id);
	}
	return fso_gsm_constants_type_id__volatile;
}
...
void fso_gsm_constants_unref (gpointer instance) {
	...
	if (g_atomic_int_dec_and_test (&self->ref_count)) {
		FSO_GSM_CONSTANTS_GET_CLASS (self)->finalize (self);
