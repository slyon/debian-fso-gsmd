/* atsmsmediators.c generated by valac 0.14.2, the Vala compiler
...
struct _FsoGsmAtSmsRetrieveTextMessagesRunData {
	...
	gint _tmp12_;
	gint _tmp13_;
	FreeSmartphoneGSMSIMMessage* _tmp14_;
	...
	gint _tmp17_;
	FreeSmartphoneGSMSIMMessage* _tmp18_;
	gint _tmp18__length1;
	gint _tmp19_;
	FreeSmartphoneGSMSIMMessage _tmp20_;
...
struct _FsoGsmAtSmsSendTextMessageRunData {
	...
	FsoGsmPlusCMMS* cmms;
	FsoGsmModem* _tmp10_;
	FsoGsmPlusCMMS* _tmp11_;
	FsoGsmPlusCMMS* _tmp12_;
	gchar* _tmp13_;
	gchar* _tmp14_;
	gint _tmp15_;
	gchar** _tmp16_;
	...
	FsoGsmPlusCMGS* cmd;
	FsoGsmModem* _tmp31_;
	FsoGsmPlusCMGS* _tmp32_;
	FsoGsmPlusCMGS* _tmp33_;
	WrapHexPdu* _tmp34_;
	gchar* _tmp35_;
	gchar* _tmp36_;
	gint _tmp37_;
	...
	FsoGsmPlusCMGS* _tmp40_;
	gchar** _tmp41_;
	gint _tmp41__length1;
	WrapHexPdu* _tmp42_;
	FsoGsmPlusCMGS* _tmp43_;
	gint _tmp44_;
	FsoGsmModem* _tmp45_;
	FsoGsmSmsHandler* _tmp46_;
	FsoGsmSmsHandler* _tmp47_;
	guint16 _tmp48_;
	FsoGsmModem* _tmp49_;
	FsoGsmPlusCMMS* _tmp50_;
	FsoGsmPlusCMMS* _tmp51_;
	gchar* _tmp52_;
	gchar* _tmp53_;
	gint _tmp54_;
	gchar** _tmp55_;
	...
	gboolean _tmp57_;
	FsoGsmModem* _tmp58_;
	FsoGsmSmsHandler* _tmp59_;
	FsoGsmSmsHandler* _tmp60_;
...
static gboolean fso_gsm_at_sms_retrieve_text_messages_real_run_co (FsoGsmAtSmsRetrieveTextMessagesRunData* _data_) {
	...
	_data_->_tmp1_ = fso_gsm_modem_get_smshandler (_data_->_tmp0_);
	_data_->_tmp2_ = _data_->_tmp1_;
	_data_->_tmp3_ = fso_gsm_sms_handler_get_storage (_data_->_tmp2_);
	_data_->_tmp4_ = _data_->_tmp3_;
	_data_->_tmp5_ = 0;
	_data_->_tmp6_ = NULL;
	_data_->_tmp6_ = fso_gsm_isms_storage_messagebook (_data_->_tmp4_, &_data_->_tmp5_);
	_data_->array = _data_->_tmp6_;
	_data_->array_length1 = _data_->_tmp5_;
	_data_->_array_size_ = _data_->array_length1;
	_data_->_tmp7_ = _data_->array;
	_data_->_tmp7__length1 = _data_->array_length1;
	_data_->_tmp8_ = NULL;
	_data_->_tmp8_ = g_new0 (FreeSmartphoneGSMSIMMessage, _data_->_tmp7__length1);
	_data_->_tmp9_ = _data_->_tmp8_;
	_data_->_tmp9__length1 = _data_->_tmp7__length1;
	fso_gsm_sms_retrieve_text_messages_set_messagebook ((FsoGsmSmsRetrieveTextMessages*) _data_->self, _data_->_tmp9_, _data_->_tmp7__length1);
	_data_->_tmp9_ = (_vala_FreeSmartphoneGSMSIMMessage_array_free (_data_->_tmp9_, _data_->_tmp9__length1), NULL);
	{
		_data_->i = 0;
		{
			_data_->_tmp10_ = TRUE;
			while (TRUE) {
				...
				_data_->_tmp14_ = _data_->array;
				_data_->_tmp14__length1 = _data_->array_length1;
				if (!(_data_->_tmp13_ < _data_->_tmp14__length1)) {
					break;
				}
				_data_->_tmp15_ = fso_gsm_sms_retrieve_text_messages_get_messagebook ((FsoGsmSmsRetrieveTextMessages*) _data_->self, &_data_->_tmp15__length1);
				_data_->_tmp16_ = _data_->_tmp15_;
				_data_->_tmp16__length1 = _data_->_tmp15__length1;
				_data_->_tmp17_ = _data_->i;
				_data_->_tmp18_ = _data_->array;
				_data_->_tmp18__length1 = _data_->array_length1;
				_data_->_tmp19_ = _data_->i;
				_data_->_tmp20_ = _data_->_tmp18_[_data_->_tmp19_];
				memset (&_data_->_tmp21_, 0, sizeof (FreeSmartphoneGSMSIMMessage));
				free_smartphone_gsm_sim_message_copy (&_data_->_tmp20_, &_data_->_tmp21_);
				free_smartphone_gsm_sim_message_destroy (&_data_->_tmp16_[_data_->_tmp17_]);
				_data_->_tmp16_[_data_->_tmp17_] = _data_->_tmp21_;
				_data_->_tmp22_ = _data_->_tmp16_[_data_->_tmp17_];
			}
		}
	}
...
static gboolean fso_gsm_at_sms_get_size_for_text_message_real_run_co (FsoGsmAtSmsGetSizeForTextMessageRunData* _data_) {
	...
	_data_->_tmp4_ = NULL;
	_data_->_tmp4_ = fso_gsm_sms_handler_formatTextMessage (_data_->_tmp2_, "+123456789", _data_->_tmp3_, FALSE);
	_data_->hexpdus = _data_->_tmp4_;
	_data_->_tmp5_ = gee_abstract_collection_get_size ((GeeCollection*) _data_->hexpdus);
	_data_->_tmp6_ = _data_->_tmp5_;
	fso_gsm_sms_get_size_for_text_message_set_size ((FsoGsmSmsGetSizeForTextMessage*) _data_->self, (guint) _data_->_tmp6_);
...
static gboolean fso_gsm_at_sms_send_text_message_real_run_co (FsoGsmAtSmsSendTextMessageRunData* _data_) {
	...
	_data_->_tmp9_ = NULL;
	_data_->_tmp9_ = fso_gsm_modem_createAtCommand (_data_->_tmp8_, FSO_GSM_TYPE_PLUS_CMMS, (GBoxedCopyFunc) g_object_ref, g_object_unref, "+CMMS");
	_data_->cmms = (FsoGsmPlusCMMS*) _data_->_tmp9_;
	_data_->_tmp10_ = fso_gsm_theModem;
	_data_->_tmp11_ = _data_->cmms;
	_data_->_tmp12_ = _data_->cmms;
	_data_->_tmp13_ = NULL;
	_data_->_tmp13_ = fso_gsm_simple_at_command_issue ((FsoGsmSimpleAtCommand*) _data_->_tmp12_, GINT_TO_POINTER (1));
	_data_->_tmp14_ = _data_->_tmp13_;
	_data_->_tmp15_ = 0;
	_data_->_state_ = 1;
	fso_gsm_modem_processAtCommandAsync (_data_->_tmp10_, (FsoGsmAtCommand*) _data_->_tmp11_, _data_->_tmp14_, FSO_GSM_MODEM_DEFAULT_RETRIES, fso_gsm_at_sms_send_text_message_run_ready, _data_);
	return FALSE;
	_state_1:
	_data_->_tmp16_ = NULL;
	_data_->_tmp16_ = fso_gsm_modem_processAtCommandAsync_finish (_data_->_tmp10_, _data_->_res_, &_data_->_tmp15_);
	_data_->_tmp17_ = _data_->_tmp16_;
	_data_->_tmp17__length1 = _data_->_tmp15_;
	_data_->_tmp17_ = (_vala_array_free (_data_->_tmp17_, _data_->_tmp17__length1, (GDestroyNotify) g_free), NULL);
	_g_free0 (_data_->_tmp14_);
	{
		_data_->_tmp18_ = _data_->hexpdus;
		_data_->_tmp19_ = _g_object_ref0 (_data_->_tmp18_);
		_data_->_hexpdu_list = _data_->_tmp19_;
		_data_->_tmp20_ = _data_->_hexpdu_list;
		_data_->_tmp21_ = gee_abstract_collection_get_size ((GeeCollection*) _data_->_tmp20_);
		_data_->_tmp22_ = _data_->_tmp21_;
		_data_->_hexpdu_size = _data_->_tmp22_;
		_data_->_hexpdu_index = -1;
		while (TRUE) {
			_data_->_tmp23_ = _data_->_hexpdu_index;
			_data_->_hexpdu_index = _data_->_tmp23_ + 1;
			_data_->_tmp24_ = _data_->_hexpdu_index;
			_data_->_tmp25_ = _data_->_hexpdu_size;
			if (!(_data_->_tmp24_ < _data_->_tmp25_)) {
				break;
			}
			_data_->_tmp26_ = _data_->_hexpdu_list;
			_data_->_tmp27_ = _data_->_hexpdu_index;
			_data_->_tmp28_ = NULL;
			_data_->_tmp28_ = gee_abstract_list_get ((GeeAbstractList*) _data_->_tmp26_, _data_->_tmp27_);
			_data_->hexpdu = (WrapHexPdu*) _data_->_tmp28_;
			_data_->_tmp29_ = fso_gsm_theModem;
			_data_->_tmp30_ = NULL;
			_data_->_tmp30_ = fso_gsm_modem_createAtCommand (_data_->_tmp29_, FSO_GSM_TYPE_PLUS_CMGS, (GBoxedCopyFunc) g_object_ref, g_object_unref, "+CMGS");
			_data_->cmd = (FsoGsmPlusCMGS*) _data_->_tmp30_;
			_data_->_tmp31_ = fso_gsm_theModem;
			_data_->_tmp32_ = _data_->cmd;
			_data_->_tmp33_ = _data_->cmd;
			_data_->_tmp34_ = _data_->hexpdu;
			_data_->_tmp35_ = NULL;
			_data_->_tmp35_ = fso_gsm_plus_cmgs_issue (_data_->_tmp33_, _data_->_tmp34_);
			_data_->_tmp36_ = _data_->_tmp35_;
			_data_->_tmp37_ = 0;
			_data_->_state_ = 2;
			fso_gsm_modem_processAtPduCommandAsync (_data_->_tmp31_, (FsoGsmAtCommand*) _data_->_tmp32_, _data_->_tmp36_, FSO_GSM_MODEM_DEFAULT_RETRIES, fso_gsm_at_sms_send_text_message_run_ready, _data_);
			return FALSE;
			_state_2:
			_data_->_tmp38_ = NULL;
			_data_->_tmp38_ = fso_gsm_modem_processAtPduCommandAsync_finish (_data_->_tmp31_, _data_->_res_, &_data_->_tmp37_);
			...
			fso_gsm_checkResponseValid ((FsoGsmAtCommand*) _data_->_tmp40_, _data_->_tmp41_, _data_->_tmp41__length1, &_data_->_inner_error_);
			if (_data_->_inner_error_ != NULL) {
				if ((_data_->_inner_error_->domain == FREE_SMARTPHONE_GSM_ERROR) || (_data_->_inner_error_->domain == FREE_SMARTPHONE_ERROR)) {
					g_simple_async_result_set_from_error (_data_->_async_result, _data_->_inner_error_);
					g_error_free (_data_->_inner_error_);
			...
			_data_->_tmp42_ = _data_->hexpdu;
			_data_->_tmp43_ = _data_->cmd;
			_data_->_tmp44_ = _data_->_tmp43_->refnum;
			_data_->_tmp42_->transaction_index = _data_->_tmp44_;
			_data_->response = (_vala_array_free (_data_->response, _data_->response_length1, (GDestroyNotify) g_free), NULL);
			_g_object_unref0 (_data_->cmd);
			_wrap_hex_pdu_unref0 (_data_->hexpdu);
		}
	...
	_data_->_tmp46_ = fso_gsm_modem_get_smshandler (_data_->_tmp45_);
	_data_->_tmp47_ = _data_->_tmp46_;
	_data_->_tmp48_ = 0U;
	_data_->_tmp48_ = fso_gsm_sms_handler_lastReferenceNumber (_data_->_tmp47_);
	fso_gsm_sms_send_text_message_set_transaction_index ((FsoGsmSmsSendTextMessage*) _data_->self, (gint) _data_->_tmp48_);
	fso_gsm_sms_send_text_message_set_timestamp ((FsoGsmSmsSendTextMessage*) _data_->self, "now");
	_data_->_tmp49_ = fso_gsm_theModem;
	_data_->_tmp50_ = _data_->cmms;
	_data_->_tmp51_ = _data_->cmms;
	_data_->_tmp52_ = NULL;
	_data_->_tmp52_ = fso_gsm_simple_at_command_issue ((FsoGsmSimpleAtCommand*) _data_->_tmp51_, GINT_TO_POINTER (0));
	_data_->_tmp53_ = _data_->_tmp52_;
	_data_->_tmp54_ = 0;
	_data_->_state_ = 3;
	fso_gsm_modem_processAtCommandAsync (_data_->_tmp49_, (FsoGsmAtCommand*) _data_->_tmp50_, _data_->_tmp53_, FSO_GSM_MODEM_DEFAULT_RETRIES, fso_gsm_at_sms_send_text_message_run_ready, _data_);
	return FALSE;
	_state_3:
	_data_->_tmp55_ = NULL;
	_data_->_tmp55_ = fso_gsm_modem_processAtCommandAsync_finish (_data_->_tmp49_, _data_->_res_, &_data_->_tmp54_);
	_data_->_tmp56_ = _data_->_tmp55_;
	_data_->_tmp56__length1 = _data_->_tmp54_;
	_data_->_tmp56_ = (_vala_array_free (_data_->_tmp56_, _data_->_tmp56__length1, (GDestroyNotify) g_free), NULL);
	_g_free0 (_data_->_tmp53_);
	_data_->_tmp57_ = _data_->want_report;
	if (_data_->_tmp57_) {
		_data_->_tmp58_ = fso_gsm_theModem;
		_data_->_tmp59_ = fso_gsm_modem_get_smshandler (_data_->_tmp58_);
		_data_->_tmp60_ = _data_->_tmp59_;
		_data_->_tmp61_ = _data_->hexpdus;
		fso_gsm_sms_handler_storeTransactionIndizesForSentMessage (_data_->_tmp60_, _data_->_tmp61_);
	}
	_g_object_unref0 (_data_->cmms);
	_g_object_unref0 (_data_->hexpdus);
	if (_data_->_state_ == 0) {
