/* atcommands.c generated by valac 0.16.0, the Vala compiler
...
static void fso_gsm_plus_clcc_real_parseMulti (FsoGsmAbstractAtCommand* base, gchar** response, int response_length1, GError** error) {
	...
	_tmp1__length1 = response_length1;
	{
		...
		for (line_it = 0; line_it < _tmp1__length1; line_it = line_it + 1) {
			...
			line = _tmp2_;
			{
				...
				FreeSmartphoneGSMCallDetail _tmp39_ = {0};
				_tmp3_ = line;
				...
				_tmp13_ = _variant_new3 (_tmp12_);
				_g_variant_unref0 (strvalue);
				strvalue = _tmp13_;
				_tmp14_ = entry;
				_tmp15_ = _tmp14_.properties;
				_tmp16_ = g_strdup ("direction");
				_tmp17_ = strvalue;
				_tmp18_ = _g_variant_ref0 (_tmp17_);
				g_hash_table_insert (_tmp15_, _tmp16_, _tmp18_);
				_tmp19_ = fso_gsm_abstract_at_command_to_string ((FsoGsmAbstractAtCommand*) self, "number");
				_tmp20_ = _tmp19_;
				_tmp21_ = fso_gsm_abstract_at_command_to_int ((FsoGsmAbstractAtCommand*) self, "typ");
				_tmp22_ = fso_gsm_constants_phonenumberTupleToString (_tmp20_, _tmp21_);
				...
				_tmp26_ = g_strdup ("peer");
				_tmp27_ = strvalue;
				_tmp28_ = _g_variant_ref0 (_tmp27_);
				g_hash_table_insert (_tmp25_, _tmp26_, _tmp28_);
				_tmp29_ = fso_gsm_abstract_at_command_to_int ((FsoGsmAbstractAtCommand*) self, "mode");
				_tmp30_ = fso_gsm_constants_callTypeToString (_tmp29_);
				_tmp31_ = _variant_new5 (_tmp30_);
				_g_variant_unref0 (strvalue);
				strvalue = _tmp31_;
				_tmp32_ = entry;
				_tmp33_ = _tmp32_.properties;
				_tmp34_ = g_strdup ("type");
				_tmp35_ = strvalue;
				_tmp36_ = _g_variant_ref0 (_tmp35_);
				g_hash_table_insert (_tmp33_, _tmp34_, _tmp36_);
				_tmp37_ = c;
				_tmp37__length1 = c_length1;
				_tmp38_ = entry;
				free_smartphone_gsm_call_detail_copy (&_tmp38_, &_tmp39_);
				_vala_array_add1 (&c, &c_length1, &_c_size_, &_tmp39_);
				_g_variant_unref0 (strvalue);
	...
	_tmp41_ = (_tmp40_ != NULL) ? _vala_array_dup1 (_tmp40_, _tmp40__length1) : ((gpointer) _tmp40_);
	...
	self->calls = _tmp41_;
	self->calls_length1 = _tmp41__length1;
	c = (_vala_FreeSmartphoneGSMCallDetail_array_free (c, c_length1), NULL);
}
