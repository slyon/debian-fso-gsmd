/* atcbmediators.c generated by valac 0.16.1, the Vala compiler
...
struct _FsoGsmAtCbSetCellBroadcastSubscriptionsRunData {
	...
	gpointer _tmp9_;
	FsoGsmPlusCSCB* cmd;
	FsoGsmPlusCSCBMode _tmp10_;
	const gchar* _tmp11_;
	FsoGsmModem* _tmp12_;
	FsoGsmModem* _tmp13_;
	FsoGsmPlusCSCB* _tmp14_;
	FsoGsmPlusCSCB* _tmp15_;
	FsoGsmPlusCSCBMode _tmp16_;
	gchar* _tmp17_;
	gchar* _tmp18_;
	gint _tmp19_;
	gchar** _tmp20_;
...
static gboolean fso_gsm_at_cb_set_cell_broadcast_subscriptions_real_run_co (FsoGsmAtCbSetCellBroadcastSubscriptionsRunData* _data_) {
	...
	_data_->_tmp9_ = NULL;
	_data_->_tmp9_ = fso_gsm_modem_createAtCommand (_data_->_tmp8_, FSO_GSM_TYPE_PLUS_CSCB, (GBoxedCopyFunc) g_object_ref, g_object_unref, "+CSCB");
	_data_->cmd = (FsoGsmPlusCSCB*) _data_->_tmp9_;
	_data_->_tmp11_ = _data_->subscriptions;
	if (g_strcmp0 (_data_->_tmp11_, "all") == 0) {
		_data_->_tmp10_ = FSO_GSM_PLUS_CSCB_MODE_ALL;
	} else {
		_data_->_tmp10_ = FSO_GSM_PLUS_CSCB_MODE_NONE;
	}
	...
	_data_->_tmp17_ = NULL;
	_data_->_tmp17_ = fso_gsm_plus_cscb_issue (_data_->_tmp15_, _data_->_tmp16_);
	_data_->_tmp18_ = _data_->_tmp17_;
	_data_->_tmp19_ = 0;
	_data_->_state_ = 1;
	fso_gsm_modem_processAtCommandAsync (_data_->_tmp13_, (FsoGsmAtCommand*) _data_->_tmp14_, _data_->_tmp18_, FSO_GSM_MODEM_DEFAULT_RETRIES, 0, fso_gsm_at_cb_set_cell_broadcast_subscriptions_run_ready, _data_);
	return FALSE;
	_state_1:
	_data_->_tmp20_ = NULL;
	_data_->_tmp20_ = fso_gsm_modem_processAtCommandAsync_finish (_data_->_tmp13_, _data_->_res_, &_data_->_tmp19_);
	_data_->_tmp21_ = _data_->_tmp20_;
	_data_->_tmp21__length1 = _data_->_tmp19_;
	_g_free0 (_data_->_tmp18_);
	_data_->response = _data_->_tmp21_;
	_data_->response_length1 = _data_->_tmp21__length1;
	_data_->_response_size_ = _data_->response_length1;
	_data_->_tmp22_ = _data_->cmd;
	fso_gsm_checkResponseOk ((FsoGsmAtCommand*) _data_->_tmp22_, _data_->response, _data_->response_length1, &_data_->_inner_error_);
...
static gboolean fso_gsm_at_cb_get_cell_broadcast_subscriptions_real_run_co (FsoGsmAtCbGetCellBroadcastSubscriptionsRunData* _data_) {
	...
	_data_->_tmp2_ = NULL;
	_data_->_tmp2_ = fso_gsm_modem_createAtCommand (_data_->_tmp1_, FSO_GSM_TYPE_PLUS_CSCB, (GBoxedCopyFunc) g_object_ref, g_object_unref, "+CSCB");
	_data_->cmd = (FsoGsmPlusCSCB*) _data_->_tmp2_;
	_data_->_tmp3_ = fso_gsm_abstract_mediator_get_modem ((FsoGsmAbstractMediator*) _data_->self);
	_data_->_tmp4_ = _data_->_tmp3_;
	_data_->_tmp5_ = NULL;
	_data_->_tmp5_ = fso_gsm_plus_cscb_query (_data_->cmd);
	_data_->_tmp6_ = _data_->_tmp5_;
	_data_->_tmp7_ = 0;
	_data_->_state_ = 1;
	fso_gsm_modem_processAtCommandAsync (_data_->_tmp4_, (FsoGsmAtCommand*) _data_->cmd, _data_->_tmp6_, FSO_GSM_MODEM_DEFAULT_RETRIES, 0, fso_gsm_at_cb_get_cell_broadcast_subscriptions_run_ready, _data_);
	return FALSE;
	_state_1:
	_data_->_tmp8_ = NULL;
	...
	_data_->_tmp10_ = _data_->cmd->mode;
	if (_data_->_tmp10_ == ((gint) FSO_GSM_PLUS_CSCB_MODE_ALL)) {
